...
var showTower = null;   // actual tower in the show tower
...
function updateStatus() {
    ...
    // data of tower
    if(showTower){
        document.getElementById('level').innerHTML = 'Level: ' + showTower.level;
        document.getElementById('experience').innerHTML = '<table><tr><td title="Experience">Exp : </td><td>' + showTower.getExperience() + '</td></tr></table>';
        document.getElementById('damage').innerHTML = 'Damage: ' + showTower.getDamage();
        document.getElementById('range').innerHTML = 'Range: ' + showTower.getRange().toFixed(2);
        document.getElementById('cooldown').innerHTML = 'Avg. Cooldown: ' + showTower.getCooldown().toFixed(2) + 's';
        
        if(!toPlace){
            showRange(showTower,showTower.pos.x, showTower.pos.y);
        }
    }
}
